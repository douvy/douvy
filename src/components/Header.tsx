      ...
      <div className="flex justify-center py-4">
        <div className="w-full md:w-10/12 lg:w-8/12 px-4">
          <div className="flex justify-end mr-[8px] sm:mr-0">
            <button
              onClick={toggleTheme}
              className={`inline-block relative w-auto h-10 rounded-md overflow-hidden border-y-2 border-x-2 border-b-solid transition-colors duration-300 ease-in-out -translate-y-0.5 font-vulf ${
                theme === 'dark' 
